...
import SecotrKeywordItem from "@src/components/SearchForm/KeywordList/SectorKeywordList/SectorKeywordItem";
...
export default function SectorsKeywordList({
  ...
  const [sectorCurrentTab, setSectorCurrentTab] = useState<any>("A"); // sector내 탭체인지
  const [activeIndex, setActiveIndex] = useState<any>(0); // sector Tab click UI change
